...
const Header = () => {
  ...
  return (
    ...
    >
      <div className="flex items-center px-5 lg:px-7.5 lx:px-10 max-lg:py-4">
          ...
          <div className="relative z-2 flex flex-col items-center justify-center m-auto lg:flex-row">
            {navigation.map((item) => (
              ...
              className={`block relative font-code text-2xl uppercase text-n-1 transition-colors hover:text-color-1
                ...
                ${item.url === pathname.hash ? 'z-2 lg:text-n-1' : 'lg:text-n-1/50'} lg:leading-5 lg:hoverLtext-n-1
                xl:px-12`}
              >
                {item.title}
              </a>
